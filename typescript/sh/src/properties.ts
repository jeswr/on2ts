...
export namespace properties {
    ...
    export class js extends Base.BaseProperty implements PropertyInterface.js {
        ...
        static OntologyValidators: Base.Validator[] = [];
        value: any;
        [sh.message] = `Does not pass the function`;

        static [sh.validator](node: Base.BaseClass): void {
        }
    }
    ...
    export class lessThan extends Base.BaseProperty implements PropertyInterface.lessThan {
        ...
        async [sh.validator](node: Base.BaseClass): Promise<boolean> {
            return true; // TODO
        }

        async [sh.message](node: Base.BaseClass): Promise<string> {
            return '';
        }
    }
